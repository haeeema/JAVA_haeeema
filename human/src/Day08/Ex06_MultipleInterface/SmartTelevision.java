...
//다중구현
//public class 클래스명 implement interfaceA interfaceB ... { }
public class SmartTelevision implements SmartRemoteControl, Searchable {
	...
	@Override
	public String[] contentSearch(String keword) {
		String[] movieContents = {"향밀침침심여정", "엘리멘탈", "범죄도시3", "장월신명"};
		String[] idolContents = {"BTS 콘서트", "뉴신스 뮤비", "아이브 공연", "라운희"};
		...
		default:
			String[] recommendContents = {"추천 컨텐츠", "메타코미디 클럽", "똥개야", "오킹", "빅조리틀조"};
